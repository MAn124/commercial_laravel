           ...
           @include('layout.header')  
            ...
            <div class="side-nav">
                <div class="side-nav-inner">
                    ...
                    <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 576px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 573px;"></div></div></ul>
                </div>
            </div>
            <!-- Side Nav END -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="m-t-50" style="height: 330px"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        <canvas class="chart chartjs-render-monitor" id="revenue-chart" style="display: block; width: 649px; height: 330px;" width="649" height="330"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="m-v-60 text-center" style="height: 200px"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        <canvas class="chart chartjs-render-monitor" id="customers-chart" style="display: block; width: 284px; height: 200px;" width="284" height="200"></canvas>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="m-t-50" style="height: 375px"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                         <canvas class="chart chartjs-render-monitor" id="avg-profit-chart" style="display: block; width: 284px; height: 375px;" width="284" height="375"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="m-t-30">
                                        <div class="overflow-y-auto scrollable relative ps-container ps-theme-default ps-active-y" style="height: 437px" data-ps-id="c55ecb84-8ac9-a0da-21ca-198b88072285">
                                        ...
                                        <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 437px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 302px;"></div></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal modal-left fade search" id="search-drawer">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body scrollable ps-container ps-theme-default" data-ps-id="88947a73-449c-ab3d-97c7-4708f408dce3">
            ...
            <div class="modal modal-right fade quick-view" id="quick-view">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body scrollable ps-container ps-theme-default" data-ps-id="233f7d99-1537-8042-cd8b-9a4f7392316b">
                            <div class="m-b-30">
